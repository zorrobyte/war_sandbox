...
};
{
	...
	if (isnil "_eosMarkers") then {_eosMarkers=[];};
		...
		null = [_x,[_HPpatrols,_HPgroupSize],[_PApatrols,_PAgroupSize],[_LVehGroups,_LVgroupSize],[_AVehGroups,_AVgroupSize],[_SVehGroups,_CHGroups,_CHgroupSize],_settings] execVM "enemy\modules\EOS\EOS\EOS_Core.sqf";
}foreach _JIPmkr;