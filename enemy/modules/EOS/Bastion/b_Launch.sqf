...
};
{
	...
	if (isnil "_eosMarkers") then {_eosMarkers=[];};
		...
		null = [_x,[_PApatrols,_PAgroupSize],[_LVehGroups,_LVgroupSize],[_AVehGroups,_AVgroupSize],[_CHGroups,_CHgroupSize],_settings] execVM "enemy\modules\EOS\Bastion\b_core.sqf";;
}foreach _JIPmkr;